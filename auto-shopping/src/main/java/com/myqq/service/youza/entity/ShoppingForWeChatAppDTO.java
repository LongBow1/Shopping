...
public class ShoppingForWeChatAppDTO {
    //region 商品列表信息
    ...
    public static class GoodsListDataRowDTO{
        ...
        public long getShiftedOnStamp() {
            return shiftedOnStamp;
        }

        public void setShiftedOnStamp(long shiftedOnStamp) {
            this.shiftedOnStamp = shiftedOnStamp;
        }
